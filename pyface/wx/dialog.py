...
def confirmation(parent, message, title=None, default=wx.NO_DEFAULT):
    ...
    dialog = wx.MessageDialog(parent, message,
                              _get_title(title, parent, 'Confirmation'),
                              wx.YES_NO | default | wx.ICON_EXCLAMATION |
                              wx.STAY_ON_TOP)
...
def information(parent, message, title=None):
    ...
    dialog = wx.MessageDialog(parent, message,
                              _get_title(title, parent, 'Information'), wx.OK |
...
def warning(parent, message, title=None):
    ...
    dialog = wx.MessageDialog(parent, message,
                              _get_title(title, parent, 'Warning'), wx.OK |
                              wx.ICON_EXCLAMATION | wx.STAY_ON_TOP)
...
def error(parent, message, title=None):
    ...
    dialog = wx.MessageDialog(parent, message,
                              _get_title(title, parent, 'Error'), wx.OK |
